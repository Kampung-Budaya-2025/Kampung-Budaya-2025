...
const Button: React.FC<ButtonProps> = ({
    ...
    const baseClassName = `flex items-center justify-center h-[42px] sm:h-[48px] md:h-[6.8vh] ${
        isLongText 
            ? 'w-[200px] sm:w-[220px] md:w-[38vh] text-sm sm:text-base md:text-[2.5vh] px-2 sm:px-3' 
            : 'w-[120px] sm:w-[140px] md:w-[26.4vh] text-base sm:text-lg md:text-[3vh] px-2'
