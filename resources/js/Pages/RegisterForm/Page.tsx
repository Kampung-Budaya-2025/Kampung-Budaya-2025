...
const RegisterForm = () => {
  ...
  const kategoriOptions = ['Lomba Desain', 'Lomba Menulis', 'Seminar', 'Workshop'];
  ...
  useEffect(() => {
    ...
    if (formData.noHandphone && !phoneRx.test(formData.noHandphone.replace(/\s+/g, ''))) {
  ...
  const handleNext = () => {
    ...
    localStorage.setItem('registrationData', JSON.stringify({ ...existing, formData, step: 1 }));
  ...
  const floatingVariants: Variants = {
    animate: {
      ...
      transition: {
        duration: 4.5,
        ease: easeInOut, // <- pakai konstanta, bukan string
        repeat: Infinity,
      },
    },
  };
  ...
  return (
    <div className="relative min-h-screen px-4 py-8 bg-gradient-to-br from-amber-50 to-orange-100 sm:py-10">
      {/* Header */}
      <motion.header
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            animate="visible"
          >
            <motion.div className="flex items-center gap-2" variants={stepVariants}>
              ...
              <span className="text-xs font-semibold text-amber-700 sm:text-sm">Data Diri</span>
            </motion.div>
            <motion.div className="w-8 h-px bg-amber-200 sm:w-10" variants={stepVariants} />
            <motion.div className="flex items-center gap-2 opacity-70" variants={stepVariants}>
              ...
              <span className="text-xs text-amber-400 sm:text-sm">Upload Berkas</span>
            </motion.div>
            <motion.div className="w-8 h-px bg-amber-100 sm:w-10" variants={stepVariants} />
            <motion.div className="flex items-center gap-2 opacity-70" variants={stepVariants}>
              <div className="flex items-center justify-center text-xs font-bold rounded-full h-7 w-7 bg-amber-100 text-amber-400 sm:h-8 sm:w-8 sm:text-sm">
                3
              </div>
              <span className="text-xs text-amber-400 sm:text-sm">Konfirmasi</span>
            </motion.div>
          </motion.div>
          ...
          >
            <h2 className="text-base font-bold text-amber-800 sm:text-lg">Data Diri</h2>
            <p className="text-xs text-amber-600 sm:text-sm">Harap isi formulir ini dengan benar</p>
          </motion.div>
          ...
          >
            {/* Nama */}
            <div>
              <label htmlFor="nama" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                Nama
              </label>
              <input
                id="nama"
            ...
            {/* Kategori */}
            <div>
              <label htmlFor="kategori" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                Kategori
              </label>
              <select
                id="kategori"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label htmlFor="tgl" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  Tanggal Lahir
                </label>
                <input
                  id="tgl"
              ...
              <div>
                <label htmlFor="instansi" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  Asal Instansi
                </label>
                <input
                  id="instansi"
                  ...
                  onChange={(e) => handleChange('asalInstansi', e.target.value)}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label htmlFor="hp" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  No. Handphone
                </label>
              ...
              <div>
                <label htmlFor="email" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  Email
                </label>
                <input
                  id="email"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label htmlFor="ig" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  Instagram
                </label>
                <input
                  id="ig"
              ...
              <div>
                <label htmlFor="line" className="block mb-1 text-sm font-medium text-gray-700 sm:mb-2">
                  ID Line
                </label>
                <input
                  id="line"
                  ...
                  onChange={(e) => handleChange('idLine', e.target.value)}
            ...
            <p className="mt-1 text-xs text-red-500">*Form Wajib Diisi</p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.button
            ...
            className={`w-full rounded-full px-6 py-3 text-base font-semibold transition sm:w-auto sm:px-10 sm:text-lg ${
              isFormValid
                ? 'bg-gradient-to-r from-amber-400 to-amber-600 text-white shadow-lg hover:from-amber-500 hover:to-amber-700'
