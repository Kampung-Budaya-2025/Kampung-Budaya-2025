    ...
    return (
        <div className="relative overflow-x-hidden">
            <AnimatedFlower
                ...
                containerClassName="block lg:hidden w-[190vw] absolute -top-22 left-1/2 flex justify-around pointer-events-none my-16 transform -translate-x-1/2"
            ...
            <div className="relative min-h-screen overflow-hidden">
                ...
                {/* Content Container */}
                <div className="relative min-h-screen z-10 flex flex-col mx-[2.4vh] lg:mx-[4.8vh] space-y-[6.4vh] pt-[26.4vh] md:pt-[28.4vh] lg:pt-[22.4vh] pb-[12vh] lg:pb-[15.2vh]">
