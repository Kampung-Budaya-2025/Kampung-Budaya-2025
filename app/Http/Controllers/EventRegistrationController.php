...
class EventRegistrationController extends Controller
{
    ...
    {
        try {
            Log::info('Event Registration Request', [
                'request_data' => $request->except(['registration_form', 'payment_proof']),
                'has_registration_form' => $request->hasFile('registration_form'),
            ...
            Log::info('Event Registration Success', [
            ...
            Log::error('Event Registration Validation Error', [
                'errors' => $e->errors(),
                'request_data' => $request->except(['registration_form', 'payment_proof'])
            ]);
